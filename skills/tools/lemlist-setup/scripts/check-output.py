#!/usr/bin/env python3
"""Validate lemlist-setup deliverables."""
...
REQUIRED_TERMS = [r"guillaume|lemwarm|verify|multichannel", r"linkedin|email"]
...
def main() -> int:
    ...
    if errors:
        print("FAIL — lemlist-setup validation:")
        for e in errors:
            print(f"  - {e}")
        return 1
    print("PASS — lemlist-setup deliverable meets standards")
    return 0
