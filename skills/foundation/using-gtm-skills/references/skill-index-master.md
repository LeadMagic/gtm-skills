<!-- AUTO-GENERATED shared reference: references/skill-index-master.md; run npm run regenerate. -->
...
| Index | Path | Use when |
|---|---|---|
| Expert catalog | `https://github.com/LeadMagic/gtm-skills/blob/main/references/experts.md` | Named practitioner lookup (113 entries) |
| Outbound experts | `https://github.com/LeadMagic/gtm-skills/blob/main/references/gtm-experts-outbound-index.md` | Cold email + discovery routing |
| Cold calling experts | `https://github.com/LeadMagic/gtm-skills/blob/main/references/cold-calling-experts-index.md` | Phone-first outbound |
| Automation playbooks | `https://github.com/LeadMagic/gtm-skills/blob/main/references/automation-playbook-index.md` | Clay, n8n, sequencing, LeadMagic (38 playbooks) |
| Lifecycle router | `https://github.com/LeadMagic/gtm-skills/blob/main/references/lifecycle-skill-index.md` | Stage-based skill selection |
| Lifecycle stages | `https://github.com/LeadMagic/gtm-skills/blob/main/references/gtm-lifecycle-stages.md` | Canonical 7-stage definitions |
| GTM ops router | `skills/gtm-ops/gtm-operations/references/gtm-ops-skill-index.md` | RevOps + spend cluster |
| Pitfalls catalog | `https://github.com/LeadMagic/gtm-skills/blob/main/references/pitfalls-index.md` | Cross-skill mistake patterns |
| GTM glossary | `https://github.com/LeadMagic/gtm-skills/blob/main/references/gtm-glossary.md` | Shared terminology |
| SaaS metrics ref | `https://github.com/LeadMagic/gtm-skills/blob/main/references/saas-metrics-reference.md` | Benchmark formulas |
| SEO playbook | `https://github.com/LeadMagic/gtm-skills/blob/main/references/seo-strategy-playbook.md` | Product-led SEO stack |
...
| Skill | One-line |
|---|---|
| `1p-tagging-pixels` | Set up first-party tracking and analytics — website pixels, conversion tracking, UTM arch… |
| `a-b-testing` | Design statistically sound GTM experiments for copy, channels, landing pages, sequencing,… |
| `attribution` | Build practical B2B attribution models across first touch, lead creation, opportunity cre… |
| `campaign-analytics` | Analyze campaign performance from deliverability through revenue: delivery, engagement, r… |
| `deliverability-monitoring` | Monitor outbound deliverability health across domains, inboxes, DNS, bounces, spam placem… |
| `event-analytics` | Customer event analytics across every GTM system — Intercom, Zendesk, Salesforce, HubSpot… |
| `growth-experimentation` | Build a growth experimentation system — ICE scoring, growth sprints, experiment design, s… |
| `gtm-metrics` | Build a GTM metrics system for SaaS: funnel conversion, pipeline velocity, win rates, CAC… |
| `gtm-system-architecture` | Design a complete GTM operating system — revenue model, data model, operating model, grow… |
| `marketing-strategy` | Build complete B2B marketing strategies — channel mix, budget allocation, content strateg… |
| `paid-advertising` | Build and manage paid advertising campaigns across B2B platforms — LinkedIn Ads, Google A… |
| `proactive-alerts` | Set up proactive GTM alert systems — CRM pipeline alerts, buying signal notifications, Sl… |
| `tracking-plan` | Master analytics tracking plan for PLG and B2B SaaS — unified event taxonomy, pixel strat… |
...
| Skill | One-line |
|---|---|
| `ai-sdr-setup` | Deploy AI SDR agents safely and effectively — vendor selection, pilot scope, guardrails,… |
| `api-enrichment` | Build API-first enrichment pipelines — provider selection, batching, retries, rate limits… |
| `attio-setup` | Set up Attio for B2B SaaS GTM — programmable CRM, custom objects, workflow automation, en… |
| `clay-automation` | Build production-grade Clay enrichment workflows — table architecture, waterfall configur… |
| `crm-integration` | Configure CRM systems for GTM — lifecycle stages, deal stages, field ownership, enrichmen… |
| `hubspot-setup` | Set up HubSpot for B2B SaaS GTM — CRM configuration, deal pipelines, lifecycle stages, ma… |
...
| Skill | One-line |
|---|---|
| `ad-creative-strategy` | Develop ad creative strategy for B2B campaigns — creative formats per platform, testing m… |
| `ai-content-creation` | AI-powered content creation workflows — step-by-step processes for using Claude, ChatGPT,… |
| `ai-video-creation` | AI-powered video creation for marketing — step-by-step workflows for HeyGen (AI spokesper… |
| `content-distribution` | Distribute content across channels for maximum reach — multi-platform repurposing, syndic… |
| `copywriting` | Write marketing copy that converts — landing pages, ads, emails, social, headlines, and b… |
| `graphic-design-gtm` | Create GTM visual assets — social graphics, ad creatives, pitch deck design, one-pager la… |
| `growth-hacking-tactics` | Tactical growth hacking playbook — rapid experimentation, growth loops, viral mechanics,… |
...
| Skill | One-line |
|---|---|
| `cs-analytics-dashboards` | Build customer success analytics dashboards — NPS, CSAT, CES, customer health scores, chu… |
| `cs-playbooks` | Build customer success playbooks — onboarding, health scoring, CSQLs, expansion plays, QB… |
| `customer-onboarding` | Design structured customer onboarding programs — time-to-value optimization, activation m… |
| `headless-support` | Design and deploy headless / automated support systems — AI chatbots, Fin AI agents, know… |
| `qbr-planning` | Plan and execute Quarterly Business Reviews — value documentation, ROI presentation, exec… |
| `sla-management` | Design and manage customer support SLAs — service level agreements, ticket priority matri… |
| `support-tool-stack` | Customer support platform selection, setup, and optimization — Intercom, Zendesk, Front,… |
...
| Skill | One-line |
|---|---|
| `battlecard-builder` | Create competitive battlecards — FIA Framework (Fact → Impact → Act), Why We Win/Why We L… |
| `case-study-builder` | Create customer case studies in sales-ready format — Challenge→Solution→Results structure… |
| `design-system-gtm` | Define brand-context for AI agents — visual identity systems, voice/tone guides, color pa… |
| `one-pager-builder` | Create one-page sales documents — product overviews, meeting leave-behinds, champion enab… |
...
| `ui-ux-gtm` | Design GTM UI/UX patterns — landing pages (hero, proof, CTA), forms (progressive disclosu… |
...
| Skill | One-line |
|---|---|
| `advisor-recruitment` | Strategic advisor recruitment for B2B SaaS founders. Use when building advisory board, re… |
...
| `employment-compliance` | Employment law and compliance for B2B SaaS founders — contractor vs employee classificati… |
| `engineer-to-founder` | Translate engineering strengths into founder-led GTM: customer discovery, positioning, de… |
| `equity-management` | Complete equity management for SaaS founders — cap tables, 409A valuations, option pools… |
| `events-planning` | Plan and execute B2B events — conferences, webinars, dinners, happy hours, trade shows, a… |
| `exiting-company` | Prepare a SaaS company for acquisition or exit — valuation drivers by buyer type (strateg… |
| `financial-modeling` | SaaS financial modeling for founders — operating model, runway, headcount, DCF valuation,… |
| `first-hires-playbook` | Complete playbook for founder's first 10 hires beyond sales. Use when hiring first engine… |
| `founder-brand` | Build a founder personal brand — LinkedIn strategy, content cadence, podcast guesting, ne… |
| `founder-comp-playbook` | Founder guide to GTM compensation — what you can afford, how to set OTE and equity, budge… |
| `founder-sales` | Founder-led sales playbook for $0-5M ARR stages. Use when founder is primary seller, buil… |
| `fundraising-strategy` | Complete fundraising strategy for B2B SaaS founders. Use when preparing to raise seed/Ser… |
| `gtm-recruiting` | GTM recruiting playbook — active sourcing, passive candidate outreach, offer negotiation,… |
| `gtm-role-descriptions` | GTM job descriptions, org structure, and compensation — role-by-role JD templates, revenu… |
| `hiring-agencies` | Evaluate, hire, and manage GTM agencies — outbound, RevOps/Clay, demand gen, design, and… |
| `hiring-by-role` | Role-specific hiring guides for B2B SaaS — interview questions, evaluation criteria, scor… |
| `hiring-contractors` | Hire and manage contractors for SaaS startups — where to find them, how to structure enga… |
| `investor-updates` | Write investor updates that build confidence and surface help — monthly format, board dec… |
...
| `saas-outcomes` | SaaS company outcomes — valuation methods, bootstrap vs VC paths, end-goal decision frame… |
| `sales-team-building` | Build a B2B sales team from first hire to scale — hiring sequence by ARR stage, WbD POD s… |
| `security-assessments` | Security assessment and vendor risk management for B2B SaaS — penetration testing, vulner… |
| `soc2-compliance` | Achieve SOC2 Type II compliance for SaaS companies — readiness assessment, control implem… |
| `solo-founder-gtm` | Build lean GTM as a solo founder or bootstrapper — tool stacks by revenue stage, AI agent… |
| `startup-communities` | Use startup communities as a GTM channel without spamming: community selection, trust-bui… |
| `vc-outreach` | Plan investor outreach for startups: target investor list, warm intro paths, cold email,… |
| `vendor-contracts` | Vendor contracts, MSAs, DPAs, and procurement for B2B SaaS — master service agreements, s… |
| `yc-ecosystem` | Navigate the public YC ecosystem for founder GTM: company research, batch mapping, outrea… |
...
| `expansion-selling` | Complete expansion and upsell playbook for B2B SaaS — consumption-based upsell triggers,… |
| `referral-programs` | Design customer and partner referral programs — 3-tier comp structure, double-sided incen… |
| `review-platforms` | B2B review site strategy — G2, Capterra, TrustRadius, Gartner Peer Insights, and Product… |
...
| Skill | One-line |
|---|---|
| `content-marketing` | Build content marketing strategies that generate pipeline — SEO/AEO optimization, pillar… |
...
| Skill | One-line |
|---|---|
| `leadmagic-bulk-enrichment` | Process CSV files with LeadMagic at scale — input cleanup, batch sizing, validation statu… |
| `leadmagic-cli` | Use the LeadMagic CLI for enrichment automation — find emails, validate contacts, enrich… |
| `leadmagic-integrations` | Integrate LeadMagic with GTM platforms — Clay, Apollo, Smartlead, Instantly, Salesforce,… |
| `leadmagic-job-change` | Use LeadMagic job-change signals for pipeline intelligence — champion tracking, account r… |
| `leadmagic-mcp` | Set up LeadMagic MCP for AI agents — tool discovery, permission scope, safe enrichment wo… |
| `leadmagic-waterfall` | Build Clay enrichment waterfalls with LeadMagic as the primary provider — 95%+ email cove… |
...
| Skill | One-line |
|---|---|
| `executive-compensation` | Canonical GTM compensation strategy — philosophy, role-by-role plans, stage- appropriate… |
| `gtm-leadership` | GTM leadership playbook for revenue leaders — how to hire and fire sales talent, run diff… |
| `revenue-team-onboarding` | Revenue team onboarding — security access provisioning, ramp schedules, 30-60-90 plans, S… |
...
| Skill | One-line |
|---|---|
| `developer-gtm` | Build a developer go-to-market motion the way Vercel, Stripe, and Twilio do — open-source… |
...
| Skill | One-line |
|---|---|
| `contact-verification` | Verify email addresses before they enter outbound sequences to prevent bounces and protec… |
| `data-enrichment-strategy` | Design an end-to-end B2B data enrichment architecture — provider selection, waterfall des… |
| `email-finding` | Find verified work email addresses for B2B contacts using multi-provider waterfall discov… |
| `lead-enrichment` | Enrich prospect and account lists with company, contact, role, technographic, intent, fun… |
| `lead-finding` | Find qualified prospects and decision-makers from ICP criteria using public research, com… |
...
| `social-intent-monitoring` | Build a social intent monitoring system that turns public social conversations into quali… |
...
| Skill | One-line |
|---|---|
| `buyer-indecision` | Overcome buyer indecision with the JOLT Effect — Judge indecision, Offer recommendation,… |
| `deal-desk` | Structure deals, pricing, and proposals — pricing model selection, discount guidance, bus… |
| `demo-scripts` | Write compelling demo scripts — first demo, technical deep-dive, and executive overview.… |
...
| Skill | One-line |
|---|---|
| `ai-prompts-toolkit` | GTM AI prompt library and prompt-loop patterns — Claygent research, LLM scoring, cold ema… |
| `analytics-toolkit` | Complete analytics tools toolkit — Segment CDP, Amplitude, Mixpanel, PostHog, GA4, and Hu… |
