...
- **Outbound recruitment:** "Your clients ask you about [problem] — we solve it.
  Let's build a referral relationship."
- **Inbound recruitment:** Partner page on your website, partner application form,
...
- **Certification:** Product certification program. Certified partners get higher
  commissions and better leads.
- **Sales playbook:** How to position your product, who to sell to, objection
  handling, demo script
...
- Partnership Ecosystem Framework: apply only the part that directly improves the requested deliverable.
