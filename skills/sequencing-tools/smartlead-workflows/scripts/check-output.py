#!/usr/bin/env python3
"""Validate smartlead-workflows deliverables."""
...
REQUIRED_TERMS = [r"eric|smartlead|verify|mailbox", r"reply|bounce|interested"]
...
def main() -> int:
    ...
    if errors:
        print("FAIL — smartlead-workflows validation:")
        for e in errors:
            print(f"  - {e}")
        return 1
    print("PASS — smartlead-workflows deliverable meets standards")
    return 0
