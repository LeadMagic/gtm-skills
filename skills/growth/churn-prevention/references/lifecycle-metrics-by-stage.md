<!-- AUTO-GENERATED shared reference: references/lifecycle-metrics-by-stage.md; run npm run regenerate. -->
...
**Ref:** `https://github.com/LeadMagic/gtm-skills/blob/main/references/chris-walker-mental-models.md`
