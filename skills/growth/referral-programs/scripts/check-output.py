#!/usr/bin/env python3
"""Validate Referral Programs deliverables."""

import sys
from pathlib import Path

TERMS = ['referral programs', 'programs', 'affiliate', 'referral', 'partner', 'mouth']
...
def main() -> int:
    ...
    print("PASS — Referral Programs deliverable meets minimum checks")
    return 0
