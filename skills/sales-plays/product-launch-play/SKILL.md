...
- "Respond to new competitor feature"
...
- LinkedIn posts from competitor executives
...
Subject: "Saw [Competitor]'s launch — interesting timing"
Body: Acknowledge the launch neutrally. "The [feature] they just launched
addresses [problem]. Most teams we work with find that [nuanced take]."
...
- Offer a call to walk through the implications
...
companies launching [type of product], they typically need [capability].
...
- Force Management Competitive Displacement: apply only the part that directly improves the requested deliverable.
