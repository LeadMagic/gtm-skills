...
metadata:
  ...
  frameworks: [ITSMA Strategic ABM, Force Management Command of the Message, John Ruhlin Giftology]
---
...
### Phase 6: Strategic Gifting (Giftology)

Gifting in ABM fails when it's transactional — logo swag, generic gift
baskets, holiday cards. John Ruhlin's Giftology framework transforms
gifting from a checkbox tactic into a relationship multiplier.

**Ruhlin's Core Principles:**

1. **Go deep, not wide.** One remarkable gift to a decision-maker is worth
   100 branded pens. Invest the budget in fewer, higher-impact gifts that
   create a story. A $500 personalized gift to the CRO > $50 gifts to 10
   end users.

2. **The 3-Gift System:**
   - **Gift 1: For them.** Something that reflects THEIR interests, not yours.
     Research their hobbies, their background, their social media. The gift
     should make them say "How did you know?"
   - **Gift 2: For their family.** A gift that includes their spouse or kids.
     This signals you see them as a person, not a budget line. It creates
     an advocate at home who asks "How's that deal going?"
   - **Gift 3: For their team.** Something their team can share. Premium
     office coffee setup. Catered lunch. This signals you respect their
     organization, not just their signature.

3. **Personalization over price.** A $100 gift that shows you know them
   (their alma mater, their favorite sports team, their hobby) beats a
   $500 generic gift basket. The goal isn't to impress with money — it's
   to demonstrate you've done the work to understand them.

4. **Gifts should have a "story."** Every gift should connect to something:
   a conversation you had, a challenge they mentioned, a milestone they
   achieved. "When you mentioned [X] on our last call, I thought of this..."
   The story is the gift; the object is just the delivery mechanism.

5. **No logo on the gift.** Gifting isn't advertising. If you put your
   logo on it, it's swag — and swag says "I care about MY brand, not YOU."
   Giftology gifts are about the recipient, not the sender.

**Gifting Sequence Timeline:**
- **Pre-first-meeting:** No gift. Too soon. It feels transactional.
- **Post-discovery call (Day 3-5):** Small personal gift. Reference
  something they mentioned. "You said you're a bourbon guy..."
- **Mid-evaluation (Week 3-4):** Significant gift. Something for their
  team. "Your team has been great to work with — sent something for
  the pod."
- **Deal stalled (any point):** No gift. Gifting to unstick a deal is
  bribery, not relationship-building. Solve the business problem.
- **Post-close (Day 1):** Family gift. "Thanks for trusting us. Sent
  something for you and [spouse's name] to enjoy."
- **90 days post-close:** "How's it going?" gift. Reinforces the
  relationship after the honeymoon period when buyer's remorse peaks.

**Gifting Rules:**
- Never exceed the recipient's company gift policy. Ask: "What's your
  company policy on gifts?" before sending anything.
- Never gift during an active negotiation. It creates ethical ambiguity.
- Always include a handwritten note. Not typed. Not printed. Handwritten.
  If you can't be bothered to write 3 sentences by hand, don't send the gift.
- Track every gift in CRM. What, when, why, the story behind it. Future
  gifts build on this history.

## Related Skills
- abm-strategy, multi-thread-orchestration, meeting-prep, pitch-deck-builder, roi-calculator
