<!-- AUTO-GENERATED shared reference: references/gtm-budget-playbook.md; run npm run regenerate. -->
...
Ben Murray (SaaS CFO): model **per-head** where possible; roll up to departments. See `https://github.com/LeadMagic/gtm-skills/blob/main/references/experts.md` — Ben Murray.
