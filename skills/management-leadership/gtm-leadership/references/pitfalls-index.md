<!-- AUTO-GENERATED shared reference: references/pitfalls-index.md; run npm run regenerate. -->
...
Master router: `skills/foundation/using-gtm-skills/SKILL.md` · Expert catalog: `https://github.com/LeadMagic/gtm-skills/blob/main/references/experts.md`
