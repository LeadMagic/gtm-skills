...
metadata:
  ...
  related_skills: [solo-founder-gtm, sales-coaching, team-management, hiring-contractors, hiring-agencies]
  frameworks: [Winning by Design POD Structures, REKS Coaching, SaaStr Hiring Triggers, QuotaSignal AE Mis-Hire Data]
---
...
| $500K-2M ARR | SDR (1st) | Feed pipeline to AEs | $55-80K | AEs maxed on capacity, pipeline thin |
| $2M+ ARR | Player-coach Manager | Manage + sell | $160-220K | 2+ reps at quota, process repeatable |
| $5M+ ARR | VP Sales | Scale the org | $220-350K+ | 5+ reps, $2M+ ARR, proven playbook |
| $5M+ ARR, 8+ reps | Sales Ops | Tools, data, reporting | $90-140K | Data/reporting chaos |
...
manager supervision.
**Days 61-90:** Full ramp, quota-bearing. Manager reviews deal reviews weekly.

Ramp time: 3-4 months to 80% productivity for experienced AEs. 4-6 months
for first-time AEs.
...
- **solo-founder-gtm**: Founder-led sales before first hire
