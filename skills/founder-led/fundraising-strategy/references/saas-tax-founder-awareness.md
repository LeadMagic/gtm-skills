<!-- AUTO-GENERATED shared reference: references/saas-tax-founder-awareness.md; run npm run regenerate. -->
...
Cross-link: `exiting-company/references/negotiating-earn-out.md` · `saas-outcomes/references/bootstrap-founder-playbook.md` · `https://github.com/LeadMagic/gtm-skills/blob/main/references/benchmark-reconciliation.md` (earn-out vs EBITDA).
...
Full expert index → `https://github.com/LeadMagic/gtm-skills/blob/main/references/experts.md`.
...
| Topic | Doc |
|---|---|
| Budget & P&L | `https://github.com/LeadMagic/gtm-skills/blob/main/references/gtm-budget-playbook.md`, `financial-modeling` |
