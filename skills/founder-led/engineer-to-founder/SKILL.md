...
1. **Friday night:** Pick the smallest version of your idea that solves ONE
...
**First hire roadmap:**
1. **Hire #1: Another engineer.** You need someone to build while you sell.
   Look for: ships fast, low ego, wants ownership.
2. **Hire #2-3: Customer-facing.** SDR or CS. Let them handle the non-technical
   work you're bad at.
3. **Hire #4-5: Specialists.** Designer, marketer, second engineer. You're
...
1. **Building before validating.** "I have a great idea. Let me spend 6 months
...
2. **Quitting with no runway.** "I'll quit my job and it'll force me to make
...
3. **Avoiding sales because "I'm an engineer."** "I'll hire a salesperson to
...
4. **Choosing tech for learning instead of shipping.** "I'll build this in
...
5. **Perfectionism as procrastination.** "Just one more refactor before we
...
6. **Isolation.** Solo founder, coding alone for 6 months, no peer group,
