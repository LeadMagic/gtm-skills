...
| Partner Type | What They Do | Revenue Model | ROI Timeline | Best For |
|---|---|---|---|---|
| **Integration / Tech** | Your product works with theirs | No rev share (mutual value) | 3-6 months | Product-led, platforms |
| **Agency / Consulting** | Implement + sell your product | 15-25% rev share (Y1) | 6-12 months | Services-heavy products |
| **Reseller / MSP** | Sell + manage your product | 20-30% margin | 6-18 months | SMB, standardized products |
| **Referral** | Recommend you, you close | 10-15% of first year | 1-3 months | Any product — lowest friction |
| **Co-Marketing** | Share audiences, co-create | No cash (audience value) | 1-3 months | Content-driven companies |
| **Technology Alliance** | Complementary products, co-sell | No rev share (deal influence) | 6-12 months | Enterprise, platforms |
...
| Type | Revenue Share | Duration | Notes |
|---|---|---|---|
| Agency | 15-25% | First-year revenue | Higher if they close, lower if you close |
| Reseller | 20-30% margin | Life of customer | Discount off list price = their margin |
| Referral | 10-15% | First-year revenue | One-time payment for qualified intro |
| Tech Alliance | None | N/A | Co-sell, influence, not transaction |

**Tier design (3 tiers):**
| Tier | Requirements | Benefits | Rev Share Bonus |
|---|---|---|---|
| **Registered** | Sign up, complete onboarding | Portal access, deal registration, training | Base rate |
| **Silver** | 3+ deals/year, 1 certification | Priority support, co-marketing, MDF | +3% |
| **Gold** | 10+ deals/year, 3 certifications | Dedicated PAM, executive alignment, beta access | +5% |
...
1. **Existing customers who are agencies** — they already love your product,
   now they can sell it to clients
2. **Complementary product ecosystems** — their users need your product (and
   vice versa)
3. **Industry events/conferences** — partner pavilions, ecosystem tracks
4. **Competitor partner pages** — who's listed as a partner? They might switch
5. **LinkedIn search** — e.g., "HubSpot Partner" + your space
...
1. **Partner portal** — deal registration, training, assets, pipeline tracking
2. **Onboarding** — product training, sales training, competitive positioning
3. **Sales assets** — partner pitch deck, joint one-pager, battlecards, case studies
4. **Co-selling playbook** — when they lead vs when you lead, handoff process
5. **Pipeline reviews** — biweekly or monthly with active partners
6. **Partner manager** — someone who owns partner success (part-time for <20 partners)
...
|---|---|---|
| Partner-sourced pipeline % | 10-25% of total | <5% — program not working |
| Partner deal win rate | Should = direct win rate | <50% of direct = enablement issue |
| Partner time to first deal | <90 days | >180 days — recruitment or onboarding issue |
| Active partner % (of signed) | >60% | <40% — too many shelf partners |
| Partner revenue growth | >30% YoY | <20% — partners stagnating |
| Deal registration to close | >25% | <15% — deal quality or enablement issue |
...
- [ ] Deal registration process built (portal, protection, expiration)
- [ ] Partner tier requirements and benefits documented
- [ ] Recruiting list built with personalized outreach
- [ ] Enablement materials created (pitch deck, one-pager, battlecards)
...
1. **Partners without enablement.** A portal with "sign up here" generates
...
2. **One-size-fits-all economics.** 15% for an agency that closes the deal
...
3. **No deal registration.** Without deal reg, partners won't share pipeline
...
4. **Too many partners, too little support.** 50 signed partners with 0 dedicated
...
5. **Hiring a VP of Partnerships too early.** If you're under $5M ARR, the
...
6. **Mixing partner types in one program.** Agencies need different economics,
