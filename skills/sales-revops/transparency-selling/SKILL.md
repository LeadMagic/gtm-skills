...
description: >-
  Execute Todd Caponi's Transparency Sale methodology — lead with flaws,
  build the "Our Flaws" slide, negotiate with radical honesty, use the
  4.2-4.5 effect in positioning. Use when building pitch decks, handling
  objections, negotiating, or designing sales process. Triggers on: 
  "transparency sale", "lead with flaws", "Todd Caponi", "radical honesty",
...
metadata:
  ...
  tags: [transparency-sale, Todd-Caponi, radical-honesty, trust, negotiation]
  related_skills: [buyer-psychology, pitch-deck-builder, objection-handling, deal-desk, competitive-intel, battlecard-builder]
  frameworks: [Todd Caponi Transparency Sale, Arthur Dunn Scientific Selling, Kahneman System 1/2]
---
...
1. **Feature gaps:** What does a competitor do that you don't? Be specific.
2. **Use case limits:** What types of companies/use cases are you bad for?
3. **Customer complaints:** What do real customers say in negative reviews?
4. **Pricing objections:** Where are you genuinely more expensive, and why?
5. **Implementation friction:** What's hard about getting started with you?
6. **Industry segments:** Where do you consistently lose deals?
...
1. **No surprises.** If discount is needed, discuss it early — don't spring
   a price change at the end. Surprises at closing kill deals.
2. **Single offer.** Don't negotiate against yourself. Present your best
   offer once. "This is the best we can do. Here's why. If it doesn't work,
   I understand."
3. **Trade, don't concede.** Every discount gets a trade: "We can reduce
   price by X if you're willing to [annual commitment / case study / reference
   call / faster implementation]."
4. **Walk-away price.** Know your floor. If they can't meet it, walk away
   warmly. "I wish we could make this work. If your situation changes,
   I'd love to reconnect."
5. **Post-agreement reinforcement.** After the deal closes, reinforce why
...
## Quality Check
- [ ] Flaws are REAL, not humblebrags
- [ ] At least one competitor is named as better at something
- [ ] At least one real customer complaint is included
- [ ] Context is provided for each flaw (who it matters to, who it doesn't)
- [ ] No discount theater — pricing is transparent

## Common Pitfalls

1. **Humblebragging as transparency.** "We care too much" is not a flaw.
...
2. **Leading with flaws but not context.** "We're expensive" without "here's
...
3. **Transparency as a phase, not a system.** Doing transparency in the
