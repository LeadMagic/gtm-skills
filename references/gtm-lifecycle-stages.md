...
**Related maps:** `references/lifecycle-skill-index.md` · `references/lifecycle-metrics-by-stage.md` · `references/activation-playbook.md` · `skills/analytics/gtm-metrics/templates/lifecycle-monitoring-dashboard.md` · `skills/analytics/gtm-metrics/templates/stage-health-scorecard.md`
